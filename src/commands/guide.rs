        ...
        printer.print_json(&serde_json::json!({
            ...
            "consumer_plane": {
                ...
                "loop": [
                    ...
                    "run (validator): `loom saga run <name>` — consecutive passing steps stamp passing with runtime evidence; the failing boundary stamps failing with the broken expectation ('expected 200, got 502'); never-reached steps stay untouched",
